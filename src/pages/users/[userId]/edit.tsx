...
const CourseCard = (props: {
	...
	const { courseData } = useCourseById(props.id);
				...
				<Card.Body>
					<div className={`d-flex ${styles.card__text}`}>
						...
						<div className={`d-flex justify-content-between w-100`}>
							<div>
								<div className={styles.result__title} role="button">{courseData && courseData['name']}</div>
								<div className={styles.result__subtitle}>{courseData && courseData['description']}</div>
							</div>
							<div>
								{/* Edit Course */}
