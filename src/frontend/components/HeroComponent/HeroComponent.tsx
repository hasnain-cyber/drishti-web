            ...
            <div className={styles.hero__content}>
                ...
                <div className={styles.hero__search}>
                    <Form className='d-flex align-items-center w-100' onSubmit={handleSubmitForm}>
                        <Form.Control required type="text" className={styles.hero__search__input} placeholder="Available learing modules" value={searchVal} onChange={(event) => setSearchVal(event.target.value)} />
